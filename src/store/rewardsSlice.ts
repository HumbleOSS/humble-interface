...
export const REWARD_OWNER_ADDRESSES = [
  ...
  // "5R4TNMJA7OK26WPRW3R5CO2I7H5UUPPGZTGDG7O3ZU3YATWYGIGOUUNVQI", // 26.01.27 reward payout
  // "4MHQB5HXNSSUOFN3K226UKNZ4H2JDG4UQMOCLZKJUEU523PZME56FM6CBY", // 26.02.03 reward payout
  // "JFEWTL4JOZ274DBY6ZTVZ3SELZBL75P5C7T5KSZNJCU66DZH5EXFL4WQTE", // 26.02.10 reward payout
  // "VECCTOM2MD5MUP4TKOBYKSKTGVV4PB46BG2YJTR2N63MBRQ5SDHT5GROLM", // 26.02.17 reward payout
  // "VONUPIS6PYZBCBNPZTJ2S75GJLX45B4BKXRFVIO4MQTISI3J2V3EPYNM2I", // 26.02.24 reward payout
  // "4FIXJVYXXAYBBVRAJDWEDZUCZKHJPVMCUBNIQEVH7IKJN6W35MB7TI66ZA", // 26.03.03 reward payout
  // "PCZUZ3LMQNPOXUVT56NX6WHYGRBKVZXREKONJ2WGEROZPTEGKLHJGNXR3Q", // 26.03.10 reward payout
  // "2AGT5SLWP7X4MPN3JSWFRBGGS2EPMWNPUV5IHUSFZ3NRDRALBMGNQURGW4", // 26.03.17 reward payout
  // "B3VA2OPZ523FQZG62WFAAQM6DSR6PKM72DLWDY4PCRWYGNEHYWKNVDZBVI", // 26.03.24 reward payout
  // "B5LWRWIJGPQCPY364EEGDC2J3YN3TRYBUOUE2OMINC3K6YBMHACJRL4EY4", // 26.03.31 reward payout
  // "HRDOPMOOBKYIQB5VEWDQEV7SCL5KRIRLXOTQVTWLHJAV3RNLRYFT3J72NA", // 26.04.11 reward payout
  "UEBK3DFYXFQOEPRDTPOL7HCHDW437VWZQUC4MZMII7F2P5PTA5ONFZRWFA", // 26.04.18 reward payouts
  "Z6OWZYJIDYZQ6FORJTT4OOK4QWAOEKKENU47WIL5M2PVDRY3AH7TY3NHGY", // 26.04.25 reward payout
  "W2OSIG56HGV6B32YVT4HNZENZBNJ2BGHFXNFTYWVHEPBYGUQTI2TZUOETA", // 26.05.02 reward payout
];

/** Stable key for dedupe, notifications, and "seen" state (matches slice logic). */
export const getRewardId = (reward: RewardTransfer): string => {
